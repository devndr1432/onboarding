...
import { CameraWithTimeout } from "../component/form/CameraWithTimeout";
import { CameraWithoutTimeout } from '../component/form/CameraWithoutTimeout';
...
export const RealQuiz: React.FC = () => {
  ...
  const [isCameraOpen, setCameraOpen] = useState<boolean>(true);
  ...
  const handleCameraOpen = () => {
    //console.log('CameraOpen component opened!');
  };

  const handleCameraClose = () => {
    setCameraOpen(false);
    console.log('main Closing camera...');
        ...
        <section className='d-flex content-justify-center m-auto'>
          <div className='container'>
            <div className='row'>
              ...
              {/* <CameraOpen /> */}
              {/* <CameraOpen onCameraOpen={handleCameraOpen} /> */}
              <CameraWithTimeout onCameraOpen={handleCameraOpen} />
          ...
          <Card>
            <div className='container'>
              ...
              <div className='row'>
                ...
                {/* <CameraOpen /> */}
                {/* <CameraOpen onCameraOpen={handleCameraOpen} /> */}
                <CameraWithoutTimeout onCameraOpen={handleCameraOpen} onCloseCamera={handleCameraClose} />
